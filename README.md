...
PowerShell commands to check installed .NET SDKs, runtimes, and environment details on Windows.
...
## PowerShell script to check installed .NET SDKs, runtimes, and environment details on Windows and export the results to a report file.
#### How to Run
```.\check-dotnet.ps1```

#### It will generate:
```dotnet-check-output.txt```
